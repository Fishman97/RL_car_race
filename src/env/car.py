...
class Car:
    ...
    def update(self, acceleration: float, brake: float, steer_left: float, steer_right: float, dt: float, map: Map):
        steering_input = steer_right - steer_left
        self.angle += steering_input * self.steering_sensitivity * dt
